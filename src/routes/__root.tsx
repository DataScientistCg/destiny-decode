...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Premium numerology by Sudhanshuu Bharti. Personalized reports, name correction, business & career guidance." },
      ...
      { name: "twitter:description", content: "Premium numerology by Sudhanshuu Bharti. Personalized reports, name correction, business & career guidance." },
    ],
    links: [
